...
export const MULTI_CLI_CASES: Case[] = [
  {
    ...
    steps: [
      ...
      { role: 'user', content: '/issue:queue', type: 'command' },
      { role: 'system', content: '┌─ 执行队列 ───────────────────────────────────┐\n│                                              │\n│ 📌 批次 1 (可并行):                         │\n│    └─ Issue-1: 购物车数据模型               │\n│                                              │\n│ 📌 批次 2 (可并行):                         │\n│    ├─ Issue-2: 购物车 API 端点              │\n│    └─ Issue-5: 前端购物车组件               │\n│                                              │\n│ 📌 批次 3 (可并行):                         │\n│    ├─ Issue-3: 商品添加/移除逻辑            │\n│    └─ Issue-6: 结算流程集成                 │\n│                                              │\n│ 📌 批次 4:                                  │\n│    └─ Issue-4: 数量修改与校验               │\n└──────────────────────────────────────────────┘', type: 'response' },
      { role: 'system', content: '💡 现在可以在 Codex 中并行执行:\n\n  窗口 1: codex\n  > /unified-execute-with-file PLAN=".workflow/active/cart/.task/" --filter=Issue-2\n\n  窗口 2: codex\n  > /unified-execute-with-file PLAN=".workflow/active/cart/.task/" --filter=Issue-5\n\n  批次 2 的两个任务可以并行开发！', type: 'tip' },
    ],
  ...
  },
  {
    ...
    commands: [
      ...
      { cmd: '/issue:queue', desc: '形成执行队列' },
      { cmd: '/unified-execute-with-file', desc: 'Codex 统一执行引擎' },
    ],
    steps: [
      ...
      { role: 'system', content: '🚀 启动 Codex 开发流水线...\n\n--- 终端 A ---\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/payment/.task/" --auto-commit\n\n--- 终端 B ---\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/payment/.task/" --auto-commit\n\n--- 终端 C ---\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/payment/.task/" --auto-commit', type: 'response' },
  ...
  },
  {
    ...
    steps: [
      ...
      { role: 'system', content: '🚀 各开发者启动 Codex:\n\n开发者 A 的终端:\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/edu-platform/user-module/.task/" --auto-commit\n\n开发者 B 的终端:\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/edu-platform/course-module/.task/" --auto-commit\n\n...(其他开发者类似)\n\n💡 每个模块在独立分支开发，完成后自动创建 PR', type: 'tip' },
  ...
  },
  {
    ...
    steps: [
      ...
      { role: 'system', content: '💡 批次 2 可拆分到多个 Codex 终端并行执行:\n\n终端 1:\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/WFS-Upload/.task/" --auto-commit\n\n终端 2:\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/WFS-Upload/.task/" --auto-commit\n\n终端 3:\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/WFS-Upload/.task/" --auto-commit', type: 'tip' },
  ...
  },
  {
    ...
    steps: [
      ...
      { role: 'system', content: '💡 切换到 Codex 终端执行开发...\n\n--- Codex 终端 1 (后端核心) ---\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/collab-editor/.task/" --auto-commit\n\n--- Codex 终端 2 (数据层) ---\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/collab-editor/.task/" --auto-commit\n\n--- Codex 终端 3 (前端) ---\n$ codex\n> /unified-execute-with-file PLAN=".workflow/active/collab-editor/.task/" --auto-commit', type: 'tip' },
