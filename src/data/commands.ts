    ...
    tips: [
      {
        ...
        tips: [
          '/workflow-lite-plan - 单人快速执行：内置规划+执行，适合1-3个简单任务',
      ...
      },
      {
        ...
        tips: [
          '第一步：/workflow-tdd - 生成 Red-Green-Refactor 任务链',
          '第二步：/workflow-execute - 执行 TDD 循环：先写测试(红)→写代码(绿)→重构',
          '完成后可再次运行 /workflow-tdd 验证 TDD 合规性：覆盖率是否达标',
        ],
      },
      {
        id: 'multi-terminal',
    ...
    tips: [
      {
        ...
        tips: [
          ...
          '/brainstorm - 统一头脑风暴：自动角色选择，AI根据任务特征并行分析',
        ],
      },
      {
        ...
        commands: ['/team-ultra-analyze'],
        commandType: 'select',
        reason: '深度分析需要多角色协作，全面理解代码库',
        tips: [
          '/team-ultra-analyze - 多角色协作，安全/性能/架构/测试/可维护性全面分析',
        ],
      },
    ],
  },
    ...
    tips: [
      {
        ...
        commands: ['/workflow-test-fix'],
        commandType: 'select',
        reason: '自动化程度越高，修复失败测试的效率越高',
        tips: [
          '/workflow-test-fix - 统一测试工作流：生成测试→执行→修复→循环直到通过',
        ],
      },
      {
        id: 'test-coverage',
    ...
    tips: [
      {
        ...
        commands: ['/review-cycle', '/review-code'],
        commandType: 'select',
        reason: '不同范围需要不同工具',
        tips: [
          '/review-cycle - 会话/模块审查：自动发现审查范围，支持自动修复',
  ...
  },
  {
    ...
    tips: [
      ...
      },
      {
        ...
        commands: ['/workflow-lite-plan', '/workflow-plan', '/brainstorm'],
        commandType: 'select',
        reason: '复杂度匹配避免过度设计或准备不足',
        tips: [
          'Level 1 - 超简单：/workflow-lite-plan，改配置、换变量名、修简单bug',
          'Level 2 - 稍复杂：/workflow-lite-plan，做一个功能、修一个问题（内置规划+执行）',
          'Level 3 - 比较复杂：/workflow-plan + /workflow-execute，改多个文件、多模块开发',
          'Level 4 - 大项目：/brainstorm 或 /workflow:brainstorm-with-file，新功能设计、架构决策',
        ],
      },
    ],
  },
