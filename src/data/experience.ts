  ...
  },
  {
    ...
    tips: [
      ...
      },
      {
        ...
        commands: [cmd('/workflow:ui-design:explore-auto'), cmd('/workflow:ui-design:imitate-auto'), cmd('/workflow:ui-design:style-extract'), cmd('/workflow:ui-design:layout-extract'), cmd('/workflow:ui-design:generate'), cmd('/team-uidesign'), cmd('/team-frontend'), cmd('/workflow:ui-design:import-from-code')],
        commandType: 'select',
        ...
        tips: [
          ...
          '【场景D】要直接出可运行的页面 — 一个 skill 搞定：',
          '  /team-frontend（内置 ui-ux-pro-max 设计智能，分析师→架构师→开发者→QA，直接出 HTML/组件代码）',
          '  或者 /team-uidesign（只要设计系统+规范，不写页面代码）',
          '  注意：team-frontend 和 team-uidesign 是独立的，不需要串联',
          '【场景E】从现有代码提取规范 — 反向工程：',
          '  ① /workflow:ui-design:import-from-code（代码→设计规范）',
          '  ② /workflow:ui-design:codify-style（规范→CSS变量/Tailwind配置）',
          '速查口诀：空白用 explore、有参考用 imitate、精细用 extract→generate、出页面用 frontend、出规范用 uidesign',
        ],
      },
    ],
  },
